...
urlpatterns = [
    ...
    path('question/<str:topic>/', views.ListQuestion.as_view(), name='list-question'),
    path('question/<str:topic>/random/', views.ListRandomQuestion.as_view(), name='list-random-question'),
